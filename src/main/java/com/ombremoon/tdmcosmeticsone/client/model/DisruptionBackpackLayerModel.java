...
public class DisruptionBackpackLayerModel extends GeoModel<TDMCosmeticItem> {
    @Override
    public ResourceLocation getModelResource(TDMCosmeticItem animatable) {
        return CommonClass.customLocation( "geo/item/disruption_backpack_layer.geo.json");
    }
